...
<form action="{{ route('ttask.edit') }}" method="POST">
@csrf
<h2>Edit Ttask</h2>
<input class="controls" type="text" name="type" id="type" placeholder="Edit ttask" maxlength="100" value="{{ $ttask->type }}" required>
<input type="hidden" value = "{{$ttask->idTta}}" name="idTta">
